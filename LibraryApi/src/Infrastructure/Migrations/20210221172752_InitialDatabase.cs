        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    BorrowingsLimit = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_AuthorAndBooks", x => x.Id);
                    table.ForeignKey(
                        name: "FK_AuthorAndBooks_Authors_AuthorId",
                        column: x => x.AuthorId,
                        principalTable: "Authors",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_AuthorAndBooks_Books_BookId",
                        column: x => x.BookId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReturnedByUser = table.Column<DateTime>(type: "datetime2", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProlongRequests", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProlongRequests_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProlongRequests_Borrowings_BorrowingId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AuthorAndBooks_AuthorId",
                table: "AuthorAndBooks",
                column: "AuthorId");

            migrationBuilder.CreateIndex(
                name: "IX_AuthorAndBooks_BookId",
                table: "AuthorAndBooks",
                column: "BookId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProlongRequests_BorrowingId",
                table: "ProlongRequests",
                column: "BorrowingId");

            migrationBuilder.CreateIndex(
                name: "IX_ProlongRequests_UserId",
                table: "ProlongRequests",
                column: "UserId");
